...
\begin{definition} \label{an:def:operations-on-Z}
    ...
    \\[3mm]
    The \textbf{addition} $+$ on $\Z$ is defined as
    \[
    [(a, b)] + [(c, d)] \coloneqq [(a + c, b + d)]
    \]
    The \textbf{multiplication} $\cdot$ on $\Z$ is defined as
    \[
...
\begin{definition} \label{an:def:operations-on-Q}
    ...
    \\[3mm]
    The \textbf{addition} $+$ on $\Q$ is defined as
    \[
    [(a, b)] + [(c, d)] \coloneqq [(ad + bc, bd)]
    \]
    The \textbf{multiplication} $\cdot$ on $\Q$ is defined as
    \[
