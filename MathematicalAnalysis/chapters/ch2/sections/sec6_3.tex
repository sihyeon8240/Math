...
\begin{proof}
    \textbf{($\implies$)} Let $E$ be compact. $E$ is closed by \Cref{thm:CompactSetsAreClosed}, and $E$ is
    bounded by \Cref{thm:CompactSetsAreBounded}.
    \\[6mm]
    ...
    \]
    Then we have $E \subseteq B_{r}(\bm{p}) \subseteq I$. By \Cref{thm:KCellsAreCompact}, $I$ is compact.
