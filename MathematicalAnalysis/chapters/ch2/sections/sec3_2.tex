...
\begin{theorem} \label{thm:FiniteUnionAndIntersectionOfFiniteSetsAreFinite}
    Let $X_{1}, X_{2}, \dots, X_{n}$ be finite sets for some $n \in \mathbb{N}$. Then the union
...
\begin{proof}
    ...
    is finite for some $n \in \mathbb{N}$, given that $X_{1}, X_{2}, \dots, X_{n}$ are finite sets.
    \begin{itemize}
...
\begin{proof}
    Let $m = \abs{X}$ and $n = \abs{Y}$. Then there exist bijections $f: J_{m} \to X$ and $g: J_{n} \to Y$.
    Let $h: J_{mn} \to X \times Y$ be defined by
    \[
...
\begin{theorem} \label{thm:ProductOfFiniteSetsIsFinite}
    Let $X_{1}, X_{2}, \dots, X_{n}$ be finite sets for some $n \in \mathbb{N}$. Then the cartesian product
    $\displaystyle\prod_{k = 1}^{n} X_{k}$ is finite.
\end{theorem}

\begin{proof}
    Let $P(n):$ $\displaystyle \prod_{k = 1}^{n} X_{k}$ is finite for some $n \in \mathbb{N}$, given that
    $X_{1}, X_{2}, \dots, X_{n}$ are finite sets.
    \begin{itemize}
        \item \textbf{Base case:} Let $X_{1}$ be a finite set. Then,
