...
\begin{lemma} \label{lem:InclusionExclusionPrincipleForTwoDisjointFiniteSets}
...
\begin{theorem} \label{thm:InclusionExclusionPrincipleForTwoFiniteSets}
...
\begin{proof}
    ...
    \end{itemize}
    By \Cref{lem:InclusionExclusionPrincipleForTwoDisjointFiniteSets}, $X, Y, X \cup Y$ are finite.
\end{proof}

\bigskip

\begin{theorem} \label{thm:InclusionExclusionPrincipleForFiniteSets}
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        Then, by \Cref{thm:InclusionExclusionPrincipleForTwoFiniteSets},
        ...
        \Cref{thm:InclusionExclusionPrincipleForTwoFiniteSets}, $\displaystyle\bigcup_{k = 1}^{n + 1} X_{k}$ is finite.
