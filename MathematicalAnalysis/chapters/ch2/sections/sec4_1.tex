...
\begin{proof}
    ...
    $(X \setminus Y) \cup Y$ is finite. Then, by \Cref{thm:SubsetOfFiniteSetIsFinite}, $X \subseteq (X \setminus Y) \cup Y$
    is finite, which contradicts the assumption. Thus, $X \setminus Y$ is infinite.
\end{proof}
