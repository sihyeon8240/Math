...
\begin{lemma} \label{lem:PuncturedNeighborhoodInRnIsNonEmpty}
...
\begin{proof}
    ...
    \]
    By \Cref{lem:PuncturedNeighborhoodInRnIsNonEmpty}, we have
    \[
...
\begin{proof}
    ...
    \]
    By \Cref{thm:NeighborhoodsAreOpen,thm:ArbitraryUnionOfOpenSetsIsOpen}, $V$ is open in $X$.
