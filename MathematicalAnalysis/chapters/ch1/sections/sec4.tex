...
\begin{itemize}
    \item $x + (+\infty) = +\infty$ for all $x \in \R \cup \set{\infty}$.
    \item $x + (-\infty) = -\infty$ for all $x \in \R \cup \set{-\infty}$.
    \item $x \cdot (\pm \infty) = \pm \infty$ for all $x \in \R^{+} \cup \set{\infty}$.
    \item $x \cdot (\pm \infty) = \mp \infty$ for all $x \in \R^{-} \cup \set{-\infty}$.
    \item $\dfrac{x}{\pm \infty} = 0$ for all $x \in \R$.
\end{itemize}
...
\begin{theorem} \label{thm:SupremumInfimumInExtendedRealNumberSystem}
    Every subset of $\overline{\R}$ has a least upper bound and a greatest lower bound in $\overline{\R}$.
\end{theorem}
